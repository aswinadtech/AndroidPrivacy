...
public static void Verify_video_ad_call_Optoutmode( )throws Exception{
	...
	System.out.println("iu=/7646/app_android_us/video call was trigred");
	logStep("iu=/7646/app_android_us/video call was trigred");
	}

	if(!sb.contains("%2F7646%2Fapp_android_us%2Fvideo")) {
	System.out.println("iu=/7646/app_android_us/video call was not trigred");
	logStep("iu=/7646/app_android_us/video call was not trigred");
	Assert.fail("iu=/7646/app_android_us/video call was not trigred");
...
public static void validate_SOD_Cust_param_video_Optoutmode() throws Exception {
	...
	logStep("Verifying  SOD custum param for iu=%2F7646%2Fapp_android_us%2Fvideo ad call");
		if(sb.toString().contains("iu=%2F7646%2Fapp_android_us%2Fvideo")){
			...
			logStep("iu=%2F7646%2Fapp_android_us%2Fvideo ad call ad call was not trigred");
			Assert.fail("iu=%2F7646%2Fapp_android_us%2Fvideo ad call ad call was not trigred");
		}
}
...
public static void validate_npa_video_ad_dontsellmyinformation() throws Exception {	
	...
	try {
		...
		if	(Read_API_Call_Data.contains("npa=1")){
			...
			logStep("npa value for iu=%2F7646%2Fapp_android_us%2Fweather%2Fsevere%2Ftropicalad call is " +"1");
			}
		else {
