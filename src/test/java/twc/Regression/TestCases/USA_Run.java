...
public class USA_Run extends TwcAndroidBaseTest {
	...
	//  Functions.validating_adcrw_privacy_Optoutmode_scenarion(); 
	 ...
	 // Functions.validating_bcp_privacy_Optoutmode_scenarion();
	  ...
	  @Test(priority = 510, enabled = true)
		@Title("Verifying WeatherFX API url call presence  for USA privacy when Advertising option set to Do Not Sell My Information")
		public void Verifying_WeatherFXAPICall_apiCall_presence_USA_Privacy_DoNotSellMyInformation() throws Exception {
  ...
  @Test(priority = 542, enabled = true)	  
	 ...
	 // Functions.validate_SOD_Cust_param_video_Optoutmode(); 
	  System.out.println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information test case  End ========================="); 
		...
		public void Verify_Criteo_SDK_config_app_Call_privacy_optout_for_USA() throws Exception {
		 ...
		 @Title("Enabling Preconfiguration for USA to LGPD Travel Scenario")
		 ...
		 @Test(priority = 556, enabled = true)  
		  @Title("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario") 
		  public void Verifying_Loatme_adcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario()  throws Exception {  
		  logStep("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario"); 
		  System.out.println("=================Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy test case  started =========================");
		  ...
		  @Title("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
		  public void Verifying_Loatme_bcpcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
		...
		//  Functions.validating_bcp_privacy_Optoutmode_scenarion();
		  ...
		  @Title("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario") 
		  public void Verifying_Factual_locationwfxtriggerscom_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception { 
		...
		//  Functions.get_aaxcal_homescreen_hourly(); 
		  ...
		  System.out.println("=================Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA Travel Scenario  test case  End ========================="); 
			...
			@Title("Verifying supress amazon Slot Id for  feed1 preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
			public void Verifying_supress_amazon_Slotid_feed1_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA__to_LGPD_Travel_Scenario() throws Exception {
		...
		@Title("Verifying supress amazon SlotId for feed2 prerload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
		public void Verifying_supress_amazon_Slotid_feed2_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
		 ...
		 @Test(priority = 570, enabled = true)
			@Title("Verifying supress amazon SlotId for  hourly details preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
			public void Verifying_Supress_amazon_Slotid_Hourlydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
			...
			System.out.println("================= Verifying supress amazon Slot Id for  hourly details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario testcase  End =========================");
			  ...
			  @Test(priority =572, enabled = true)
				@Title("Verifying supress amazon SlotId for  hourly1 details big ad  preload call USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
				public void Verifying_Supress_amazon_Slotid_Hourly1_bigaddetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
					System.out.println(
				...
				@Title("Verifying supress amazon SlotId for  hourly2 details big ad  preload call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
				...
				@Title("Verifying supress amazon SlotId for  hourly3 details big ad preload call USA privacy when Advertising option set to Do Not Sell My Information for USA  to LGPD Travel Scenario")
			...
			@Title("Verifying supress amazon SlotId for maps details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
			public void Verifying_supress_amazon_Slotid_mapsdetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
			...
			@Title("Verifying supress amazon SlotId for daily details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD  Travel Scenario")
			public void Verifying_supress_amazon_Slotid_Dailydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
			...
			@Title("Verifying supress amazon SlotId for videos preload ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario")
			public void Verifying_supress_amazon_Slotid_video_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
	   ...
	   System.out.println("=================Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD  Travel Scenario  testcase started =========================" );
		  ...
		  public void Verifying_homescreenmarquee_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario()   throws	 Exception {
		  logStep("Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" ); 
		  System.out. println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================" );  
		//  Functions.finding_Homescreen_marquee_iu_value();
		  System.out.println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case End =========================" );	  
		  }
		  
		  
		  @Test(priority = 588, enabled = true)	  
		  @Title("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" )
		  public void   Verifying_SOD_Cust_Param_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws  Exception {
		  logStep("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" ); 
		  System.out.println("=================Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case  started ========================="); 
		//  Functions.validate_SOD_Cust_param_homescreenmarquee_Optoutmode();
		  System.out.println("================= Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case End =========================" ); 
		  }
		 ...
		 /* @Test(priority = 590, enabled = true)	  
		  ...
		  public void Verifying_SOD_Cust_Param_mapsdetails_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception { 
		 System.out. println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================" );
		  logStep("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" );  
		 // Functions.validate_SOD_Cust_param_deatiledfeed_Optoutmode();
		  System.out. println("================= Verifying SOD Cust param value in maps details page ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD  Travel Scenario test case End =========================" );
		  }
		  ...
		  public void
		  Verifying_rdp_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws  Exception {
		  logStep("Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario"); 
		  System.out.println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================" ); 
		  //Functions.validate_RDP_homescreenmarquee_Optoutmode();
		  System.out. println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD  Travel Scenario test case End =========================");
	      }
		  
		  
		  @Test(priority = 598, enabled = true)	  
		  ...
		  public void Verifying_videos_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario()  throws   Exception {
		System.out. println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================" );
		  logStep("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario"); 	
		  logStep("Verifying supress of normal amazon slotid in feed_1  for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario");
		//  Functions.Verify_video_ad_call_Optoutmode(); 
		  System.out.println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started End =========================" );  
		  }
		
		  @Test(priority = 600, enabled = true)	  
		  @Title("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" ) 
		  public void  Verifying_SOD_Cust_Param_videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
		  logStep("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" ); 
		  System.out. println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================" );
		//  Functions.validate_SOD_Cust_param_video_Optoutmode(); 
		  System.out.println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD  Travel Scenario test case  End ========================="); 
		  }
		

			 @Test(priority = 602, enabled = true)	  
			  @Title("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" ) 
			  public void Verifying_rdp_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
			  logStep("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA  to LGPD Travel Scenario" );  
			  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD  Travel Scenario test case started =========================");
			//  Functions.validate_RDP_video_ad_Optoutmode();
			  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case End =========================");
			  }
			 ...
			 /* @Test(priority = 604, enabled = true)	  
			  ...
			  public void Verifying_npa_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws  Exception {
			  logStep("Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario"); 
			  System.out.println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================" ); 
				// Functions.validate_npa_homescreenmarquee_dontsellmyinformation();
			  System.out. println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case End =========================");
		      }
			 
				
				@Test(priority =608, enabled = true)  
				 @Title("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario") 
				 public void Verifying_npa_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LGPD_Travel_Scenario() throws Exception {
				 logStep("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario" );  	  
				  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LGPD Travel Scenario test case started =========================");
				...
				@Title("Verify Criteo SDK inapp v2 call when privacy optout for USA to LGPD Travel Scenario")
				...
				@Title("Verify Criteo SDK config app call when privacy optout for USA to LGPD Travel Scenario")
				...
				//==========================================================================================================//
				//USA to LGPD travelling test cases End
				//==========================================================================================================//
				
				
				//==========================================================================================================//
				//USA to GDPR  travelling test cases End
				//==========================================================================================================//
				 ...
				 @Test(priority = 616, enabled = true)  
				  @Title("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario") 
				  public void Verifying_Loatme_adcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario()  throws Exception {  
				  logStep("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 
				  System.out.println("=================Verifying Lotame ad.crwdcntrl.net api call supressing for USA  to GDPR travelling  privacy test case  started =========================");
				 
				  System.out.println("================= Verifying Lotame ad.crwdcntrl.net api call supressing for USA to GDPR travelling  privacy test case End =========================");	  
				  }
				  ...
				  @Title("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
				  public void Verifying_Loatme_bcpcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
				  logStep("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" ); 
				  System.out.println("=================Verifying BCP api call when user selecting Optoutmode scenario in privacy card started =========================" );
				//  Functions.validating_bcp_privacy_Optoutmode_scenarion();
				  System.out.println("================= Verifying BCP api call when user selecting Optoutmode scenario in privacy card End =========================");  
				  }
				  ...
				  @Title("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario") 
				  public void Verifying_Factual_locationwfxtriggerscom_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception { 
				  logStep("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 
				 System.out.println("=================Verifying Fatual api call when user selecting Optoutmode scenario in privacy card started =========================");
				// Functions.validating_Fatualcall_privacy_Optoutmode_scenarion();
				 System.out. println("================= Verifying Fatual api call when user selecting Optoutmode scenario in privacy card End =========================");
				  }
				...
				//  Functions.get_aaxcal_homescreen_hourly(); 
				  ...
				  System.out.println("=================Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR  Travel Scenario  test case  End ========================="); 
					...
					@Title("Verifying supress amazon Slot Id for  feed1 preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
					public void Verifying_supress_amazon_Slotid_feed1_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA__to_GDPR_Travel_Scenario() throws Exception {
				...
				@Title("Verifying supress amazon SlotId for feed2 prerload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
				public void Verifying_supress_amazon_Slotid_feed2_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
				 ...
				 @Test(priority = 630, enabled = true)
					@Title("Verifying supress amazon SlotId for  hourly details preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
					public void Verifying_Supress_amazon_Slotid_Hourlydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
					...
					System.out.println("================= Verifying supress amazon Slot Id for  hourly details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario testcase  End =========================");
					  ...
					  @Test(priority =632, enabled = true)
						@Title("Verifying supress amazon SlotId for  hourly1 details big ad  preload call USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
						public void Verifying_Supress_amazon_Slotid_Hourly1_bigaddetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
							System.out.println(
						...
						@Title("Verifying supress amazon SlotId for  hourly2 details big ad  preload call  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
						...
						@Title("Verifying supress amazon SlotId for  hourly3 details big ad preload call USA privacy when Advertising option set to Do Not Sell My Information for USA  to GDPR Travel Scenario")
					...
					@Title("Verifying supress amazon SlotId for maps details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
					public void Verifying_supress_amazon_Slotid_mapsdetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
					...
					@Title("Verifying supress amazon SlotId for daily details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
					public void Verifying_supress_amazon_Slotid_Dailydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
					...
					@Title("Verifying supress amazon SlotId for videos preload ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
					public void Verifying_supress_amazon_Slotid_video_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
			   ...
			   System.out.println("=================Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR  Travel Scenario  testcase started =========================" );
				  ...
				  public void Verifying_homescreenmarquee_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario()   throws	 Exception {
				  logStep("Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" ); 
				  System.out. println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================" );  
				 // Functions.finding_Homescreen_marquee_iu_value();
				  System.out.println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case End =========================" );	  
				  }
				  
				  
				  @Test(priority = 648, enabled = true)	  
				  @Title("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" )
				  public void   Verifying_SOD_Cust_Param_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws  Exception {
				  logStep("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" ); 
				  System.out.println("=================Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case  started ========================="); 
				 // Functions.validate_SOD_Cust_param_homescreenmarquee_Optoutmode();
				  System.out.println("================= Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case End =========================" ); 
				  }
				  ...
				  public void Verifying_SOD_Cust_Param_mapsdetails_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception { 
				 System.out. println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================" );
				  logStep("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" );  
				 // Functions.validate_SOD_Cust_param_deatiledfeed_Optoutmode();
				  System.out. println("================= Verifying SOD Cust param value in maps details page ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR  Travel Scenario test case End =========================" );
				  }
				  ...
				  public void
				  Verifying_rdp_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws  Exception {
				  logStep("Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 
				  System.out.println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================" ); 
				//  Functions.validate_RDP_homescreenmarquee_Optoutmode();
				  System.out. println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR  Travel Scenario test case End =========================");
			      }
				  
				  
				  @Test(priority = 658, enabled = true)	  
				  @Title("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario") 
				  public void Verifying_videos_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario()  throws   Exception {
				System.out. println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================" );
				  logStep("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 	
				  logStep("Verifying supress of normal amazon slotid in feed_1  for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario");
				//  Functions.Verify_video_ad_call_Optoutmode(); 
				  System.out.println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started End =========================" );  
				  }
				
				  @Test(priority = 660, enabled = true)	  
				  @Title("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" ) 
				  public void  Verifying_SOD_Cust_Param_videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
				  logStep("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" ); 
				  System.out. println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================" );
				 // Functions.validate_SOD_Cust_param_video_Optoutmode(); 
				  System.out.println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR  Travel Scenario test case  End ========================="); 
				  }
				

					 @Test(priority = 662, enabled = true)	  
					  @Title("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" ) 
					  public void Verifying_rdp_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
					  logStep("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA  to GDPR Travel Scenario" );  
					  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR  Travel Scenario test case started =========================");
					  //Functions.validate_RDP_video_ad_Optoutmode();
					  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case End =========================");
					  }
					 ...
					 /* @Test(priority = 664, enabled = true)	  
					  ...
					  public void Verifying_npa_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws  Exception {
					  logStep("Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 
					  System.out.println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================" ); 
						// Functions.validate_npa_homescreenmarquee_dontsellmyinformation();
					  System.out. println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case End =========================");
				      }
					  
						
						@Test(priority =668, enabled = true)  
						 @Title("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario") 
						 public void Verifying_npa_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_GDPR_Travel_Scenario() throws Exception {
						 logStep("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario" );  	  
						  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case started =========================");
						// Functions.validate_npa_video_ad_dontsellmyinformation();
						 System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario test case End =========================");
						...
						@Title("Verify Criteo SDK inapp v2 call when privacy optout for USA to GDPR Travel Scenario")
						public void Verify_Criteo_SDK_inapp_v2_Call_privacy_optout_for_USA_to_GDPR_Travel_Scenario_tedt() throws Exception {
							System.out.println("==============================================");
							System.out.println(
					...
					//Functions.verifyCriteo_inapp_v2_Call("Criteo", false);
						...
						@Title("Verify Criteo SDK config app call when privacy optout for USA to GDPR Travel Scenario")
						...
						//==========================================================================================================//
						//USA to LATAMCO  travelling test cases Started
						//==========================================================================================================//
						 ...
						 @Test(priority = 676, enabled = true)  
						  @Title("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario") 
						  public void Verifying_Loatme_adcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario()  throws Exception {  
						  logStep("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 
						  System.out.println("=================Verifying Lotame ad.crwdcntrl.net api call supressing for USA  to GDPR travelling  privacy test case  started =========================");
						
						  System.out.println("================= Verifying Lotame ad.crwdcntrl.net api call supressing for USA to LATAMCO travelling  privacy test case End =========================");	  
						  }
						  
						  @Test(priority = 678, enabled = true)	  
						  @Title("Verifying WeatherFXAPICall_apiCall_presence api for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
						  ...
						  @Title("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
						  public void Verifying_Loatme_bcpcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
						  logStep("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ); 
						  System.out.println("=================Verifying BCP api call when user selecting Optoutmode scenario in privacy card started =========================" );
						 // Functions.validating_bcp_privacy_Optoutmode_scenarion();
						  System.out.println("================= Verifying BCP api call when user selecting Optoutmode scenario in privacy card End =========================");  
						  }
						  ...
						  @Title("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario") 
						  public void Verifying_Factual_locationwfxtriggerscom_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception { 
						  logStep("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario"); 
						 System.out.println("=================Verifying Fatual api call when user selecting Optoutmode scenario in privacy card started =========================");
						// Functions.validating_Fatualcall_privacy_Optoutmode_scenarion();
						 System.out. println("================= Verifying Fatual api call when user selecting Optoutmode scenario in privacy card End =========================");
						  }
						 ...
						 /* @Test(priority=684,enabled = true)  
						  @Title("Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario") 
						  public void Verifying_Supress_amazon_Slotid_homescreenhourly_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception { 
						  System.out.println("=================Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case Started========================="); 
						//  Functions.get_aaxcal_homescreen_hourly(); 
						  logStep("Verifying supress amazon slot id for  home screen hourly preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario");
						  Functions.verifyaax_SlotId_supress("869c843c-7cf8-47ae-b6ed-088057e4bc8a");
						  System.out.println("=================Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario  test case  End ========================="); 
						  }*/
						
						 
							@Test(priority = 686, enabled = true)
							@Title("Verifying supress amazon Slot Id for  feed1 preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
							public void Verifying_supress_amazon_Slotid_feed1_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA__to_LATAMCO_Travel_Scenario() throws Exception {
						...
						@Title("Verifying supress amazon SlotId for feed2 prerload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
						public void Verifying_supress_amazon_Slotid_feed2_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
						 ...
						 @Test(priority = 690, enabled = true)
							@Title("Verifying supress amazon SlotId for  hourly details preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
							public void Verifying_Supress_amazon_Slotid_Hourlydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
							...
							System.out.println("================= Verifying supress amazon Slot Id for  hourly details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario testcase  End =========================");
							  ...
							  @Test(priority =692, enabled = true)
								@Title("Verifying supress amazon SlotId for  hourly1 details big ad  preload call USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
								public void Verifying_Supress_amazon_Slotid_Hourly1_bigaddetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
									System.out.println(
								...
								@Title("Verifying supress amazon SlotId for  hourly2 details big ad  preload call  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
								...
								@Test(priority = 698, enabled = true)
								@Title("Verifying supress amazon SlotId for  hourly3 details big ad preload call USA privacy when Advertising option set to Do Not Sell My Information for USA  to LATAMCO Travel Scenario")
							...
							@Title("Verifying supress amazon SlotId for maps details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario")
							public void Verifying_supress_amazon_Slotid_mapsdetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
							...
							@Title("Verifying supress amazon SlotId for daily details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
							public void Verifying_supress_amazon_Slotid_Dailydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
							...
							@Title("Verifying supress amazon SlotId for videos preload ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario")
							public void Verifying_supress_amazon_Slotid_video_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
						...
						/*@Test(priority =706, enabled = true)  
						  @Title("Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ) 
						  public void  Verifying_homescreenhourly_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
					   System.out.println("=================Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario  testcase started =========================" );
						  logStep("Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario");
						  Functions.finding_Homescreen_iu_value();
						  System.out.println("=================Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario  testcase  End =========================" );	  
						  }*/
						  
						  @Test(priority =708, enabled = true)	  
						  @Title("Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA  to LATAMCO Travel Scenario" )	
						  public void Verifying_homescreenmarquee_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario()   throws	 Exception {
						  logStep("Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ); 
						  System.out. println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================" );  
						//  Functions.finding_Homescreen_marquee_iu_value();
						  System.out.println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case End =========================" );	  
						  }
						  
						  
						  @Test(priority = 710, enabled = true)	  
						  @Title("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" )
						  public void   Verifying_SOD_Cust_Param_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws  Exception {
						  logStep("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ); 
						  System.out.println("=================Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case  started ========================="); 
						//  Functions.validate_SOD_Cust_param_homescreenmarquee_Optoutmode();
						  System.out.println("================= Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case End =========================" ); 
						  }


						  /*@Test(priority = 712, enabled = true)	  
						  @Title("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" )
						  public void  Verifying_SOD_Cust_Param_homescreenhourly_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws  Exception {
						  logStep("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ); 
						  System.out.println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario test case started ========================="); 
						  Functions.validate_SOD_Cust_param_homescreenHourly_Optoutmode();
						  System.out.println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case End =========================" ); 
						  }*/
						
						  @Test(priority = 714, enabled = true)	  
						  @Title("Verifying SOD Cust param value in maps details page ad call for USA _CCPA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" )
						  public void Verifying_SOD_Cust_Param_mapsdetails_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception { 
						 System.out. println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================" );
						  logStep("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" );  
						//  Functions.validate_SOD_Cust_param_deatiledfeed_Optoutmode();
						  System.out. println("================= Verifying SOD Cust param value in maps details page ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario test case End =========================" );
						  }
						  ...
						  public void
						  Verifying_rdp_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws  Exception {
						  logStep("Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario"); 
						  System.out.println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================" ); 
						 // Functions.validate_RDP_homescreenmarquee_Optoutmode();
						  System.out. println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario test case End =========================");
					      }
						  
						  
						  @Test(priority = 720, enabled = true)	  
						  @Title("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario") 
						  public void Verifying_videos_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario()  throws   Exception {
						System.out. println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================" );
						  logStep("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario"); 	
						  logStep("Verifying supress of normal amazon slotid in feed_1  for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario");
						 // Functions.Verify_video_ad_call_Optoutmode(); 
						  System.out.println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started End =========================" );  
						  }
						
						  @Test(priority = 722, enabled = true)	  
						  @Title("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ) 
						  public void  Verifying_SOD_Cust_Param_videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
						  logStep("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ); 
						  System.out. println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================" );
						 // Functions.validate_SOD_Cust_param_video_Optoutmode(); 
						  System.out.println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario test case  End ========================="); 
						  }
						

							 @Test(priority = 724, enabled = true)	  
							  @Title("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" ) 
							  public void Verifying_rdp_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
							  logStep("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA  to LATAMCO Travel Scenario" );  
							  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario test case started =========================");
							 // Functions.validate_RDP_video_ad_Optoutmode();
							  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case End =========================");
							  }
							  

						
							 /* @Test(priority = 726, enabled = true)	  
							  @Title("Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario") 
							  public void  Verifying_npa_equals_1_homescreenHourly_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws  Exception {
							  logStep("Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario"); 
							  System.out.println("================= Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case  started =========================" ); 
							  Functions.validate_npa_homescrenhourly_dontsellmyinformation();
							  System.out. println("================= Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case  End =========================");
						      }*/
							  
							  @Test(priority = 728, enabled = true)	  
							  @Title("Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO  Travel Scenario") 
							  public void Verifying_npa_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws  Exception {
							  logStep("Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario"); 
							  System.out.println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================" ); 
								// Functions.validate_npa_homescreenmarquee_dontsellmyinformation();
							  System.out. println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case End =========================");
						      }
							  
								
								@Test(priority =730, enabled = true)  
								 @Title("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario") 
								 public void Verifying_npa_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_LATAMCO_Travel_Scenario() throws Exception {
								 logStep("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario" );  	  
								  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case started =========================");
								// Functions.validate_npa_video_ad_dontsellmyinformation();
								 System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to LATAMCO Travel Scenario test case End =========================");
								...
								@Title("Verify Criteo SDK inapp v2 call when privacy optout for USA to LATAMCO Travel Scenario")
								public void Verify_Criteo_SDK_inapp_v2_Call_privacy_optout_for_USA_to_LATAMCO_Travel_Scenario_tedt() throws Exception {
									System.out.println("==============================================");
									System.out.println(
							...
							//Functions.verifyCriteo_inapp_v2_Call("Criteo", false);
								...
								@Title("Verify Criteo SDK config app call when privacy optout for USA to LATAMCO Travel Scenario")
								...
								//==========================================================================================================//
								//USA to LATAMCO travelling test cases End
								//==========================================================================================================//
								...
								@Test(priority = 736, enabled = true)
								 ...
								 @Test(priority = 738, enabled = true)  
								  @Title("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
								  public void Verifying_Loatme_adcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario()  throws Exception {  
								  logStep("Verifying Lotame ad.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to GDPR Travel Scenario"); 
								  System.out.println("=================Verifying Lotame ad.crwdcntrl.net api call supressing for USA  to SERBIA travelling  privacy test case  started =========================");
								
								  System.out.println("================= Verifying Lotame ad.crwdcntrl.net api call supressing for USA to SERBIA travelling  privacy test case End =========================");	  
								  }
								  
								  @Test(priority = 740, enabled = true)	  
								  @Title("Verifying WeatherFXAPICall_apiCall_presence api for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
								  ...
								  @Title("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
								  public void Verifying_Loatme_bcpcrwdcntrlnet_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
								  logStep("Verifying Lotame bcp.crwdcntrl.net api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ); 
								  System.out.println("=================Verifying BCP api call when user selecting Optoutmode scenario in privacy card started =========================" );
								 // Functions.validating_bcp_privacy_Optoutmode_scenarion();
								  System.out.println("================= Verifying BCP api call when user selecting Optoutmode scenario in privacy card End =========================");  
								  }
								  ...
								  @Title("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
								  public void Verifying_Factual_locationwfxtriggerscom_apiCall_supressing_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception { 
								  logStep("Verifying Factual location.wfxtriggers.com api call supressing for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario"); 
								 System.out.println("=================Verifying Fatual api call when user selecting Optoutmode scenario in privacy card started =========================");
								 //Functions.validating_Fatualcall_privacy_Optoutmode_scenarion();
								 System.out. println("================= Verifying Fatual api call when user selecting Optoutmode scenario in privacy card End =========================");
								  }
								 ...
								 /* @Test(priority=748,enabled = true)  
								  @Title("Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
								  public void Verifying_Supress_amazon_Slotid_homescreenhourly_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception { 
								  System.out.println("=================Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case Started========================="); 
								//  Functions.get_aaxcal_homescreen_hourly(); 
								  logStep("Verifying supress amazon slot id for  home screen hourly preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario");
								  Functions.verifyaax_SlotId_supress("869c843c-7cf8-47ae-b6ed-088057e4bc8a");
								  System.out.println("=================Verifying supress amazon slotid for  home screen hourly preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario  test case  End ========================="); 
								  }*/
								
								 
									@Test(priority = 750, enabled = true)
									@Title("Verifying supress amazon Slot Id for  feed1 preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
									public void Verifying_supress_amazon_Slotid_feed1_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA__to_SERBIA_Travel_Scenario() throws Exception {
										System.out.println("=================Verifying supress amazon Slot Id for  feed1 preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario testcase Started =========================");
										logStep("Verifying supress amazon Slot Id for  feed1 prerol ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario");
										//Functions.get_aaxcal_feed1();
										  //Functions.verifyaax_SlotId_supress("f4b66249-b6eb-4155-9d90-1e2b04487c99");
										System.out.println("=================Verifying supress amazon Slot Id for  feed1 preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario testcase End =========================");

									}
								
								@Test(priority = 752, enabled = true)
								@Title("Verifying supress amazon SlotId for feed2 prerload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
								public void Verifying_supress_amazon_Slotid_feed2_preroladcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
								 ...
								 @Test(priority = 754, enabled = true)
									@Title("Verifying supress amazon SlotId for  hourly details preload ad call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
									public void Verifying_Supress_amazon_Slotid_Hourlydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
									...
									System.out.println("================= Verifying supress amazon Slot Id for  hourly details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario testcase  End =========================");
									  ...
									  @Test(priority =756, enabled = true)
										@Title("Verifying supress amazon SlotId for  hourly1 details big ad  preload call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
										public void Verifying_Supress_amazon_Slotid_Hourly1_bigaddetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
											System.out.println(
										...
										@Title("Verifying supress amazon SlotId for  hourly2 details big ad  preload call  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
										...
										@Title("Verifying supress amazon SlotId for  hourly3 details big ad preload call USA privacy when Advertising option set to Do Not Sell My Information for USA  to SERBIA Travel Scenario")
									...
									@Title("Verifying supress amazon SlotId for maps details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
									public void Verifying_supress_amazon_Slotid_mapsdetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
									...
									@Title("Verifying supress amazon SlotId for daily details preload ad call USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
									public void Verifying_supress_amazon_Slotid_Dailydetails_preload_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
									...
									@Title("Verifying  amazon SlotId for videos preload ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario")
									public void Verifying_supress_amazon_Slotid_video_adcall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
								...
								/*@Test(priority =768, enabled = true)  
								  @Title("Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ) 
								  public void  Verifying_homescreenhourly_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
							   System.out.println("=================Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario  testcase started =========================" );
								  logStep("Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario");
								  Functions.finding_Homescreen_iu_value();
								  System.out.println("=================Verifying home screen hourly ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario  testcase  End =========================" );	  
								  }*/
								  
								  @Test(priority =770, enabled = true)	  
								  @Title("Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA  to SERBIA Travel Scenario" )	
								  public void Verifying_homescreenmarquee_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario()   throws	 Exception {
								  logStep("Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ); 
								  System.out. println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================" );  
								//  Functions.finding_Homescreen_marquee_iu_value();
								  System.out.println("=================Verifying home screen marquee ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case End =========================" );	  
								  }
								  
								  
								  @Test(priority = 772, enabled = true)	  
								  @Title("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" )
								  public void   Verifying_SOD_Cust_Param_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws  Exception {
								  logStep("Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ); 
								  System.out.println("=================Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case  started ========================="); 
								 // Functions.validate_SOD_Cust_param_homescreenmarquee_Optoutmode();
								  System.out.println("================= Verifying SOD Cust param value in homescreen marquee call for  USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case End =========================" ); 
								  }


								 /* @Test(priority = 774, enabled = true)	  
								  @Title("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" )
								  public void  Verifying_SOD_Cust_Param_homescreenhourly_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws  Exception {
								  logStep("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ); 
								  System.out.println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario test case started ========================="); 
								  Functions.validate_SOD_Cust_param_homescreenHourly_Optoutmode();
								  System.out.println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case End =========================" ); 
								  }*/
								
								  @Test(priority = 776, enabled = true)	  
								  @Title("Verifying SOD Cust param value in maps details page ad call for USA _CCPA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" )
								  public void Verifying_SOD_Cust_Param_mapsdetails_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception { 
								 System.out. println("================= Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================" );
								  logStep("Verifying SOD Cust param value in homescreen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" );  
								 // Functions.validate_SOD_Cust_param_deatiledfeed_Optoutmode();
								  System.out. println("================= Verifying SOD Cust param value in maps details page ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario test case End =========================" );
								  }
								  
								  
								  
								 /* @Test(priority = 778, enabled = true)	  
								  @Title("Verifying rdp=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
								  public void  Verifying_rdp_equals_1_homescreenHourly_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws  Exception {
								  logStep("Verifying rdp=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario"); 
								  System.out.println("================= Verifying rdp=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case  started =========================" ); 
								  Functions.validate_RDP_homescrenhourly_Optoutmode();
								  System.out. println("================= Verifying rdp=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case  End =========================");
							      }*/
								  
								  @Test(priority = 780, enabled = true)	  
								  @Title("Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
								  public void
								  Verifying_rdp_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws  Exception {
								  logStep("Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario"); 
								  System.out.println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================" ); 
								  //Functions.validate_RDP_homescreenmarquee_Optoutmode();
								  System.out. println("================= Verifying rdp=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario test case End =========================");
							      }
								  
								  
								  @Test(priority = 782, enabled = true)	  
								  @Title("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
								  public void Verifying_videos_adCall_Presence_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario()  throws   Exception {
								System.out. println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================" );
								  logStep("Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario"); 	
								  logStep("Verifying supress of normal amazon slotid in feed_1  for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario");
								//  Functions.Verify_video_ad_call_Optoutmode(); 
								  System.out.println("=================Verifying videos ad call presense for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started End =========================" );  
								  }
								
								  @Test(priority = 784, enabled = true)	  
								  @Title("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ) 
								  public void  Verifying_SOD_Cust_Param_videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
								  logStep("Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ); 
								  System.out. println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================" );
								//  Functions.validate_SOD_Cust_param_video_Optoutmode(); 
								  System.out.println("================= Verifying SOD Cust param value in Videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario test case  End ========================="); 
								  }
								

									 @Test(priority = 786, enabled = true)	  
									  @Title("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" ) 
									  public void Verifying_rdp_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
									  logStep("Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA  to SERBIA Travel Scenario" );  
									  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario test case started =========================");
									//  Functions.validate_RDP_video_ad_Optoutmode();
									  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case End =========================");
									  }
									  

								
									 /* @Test(priority = 788, enabled = true)	  
									  @Title("Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
									  public void  Verifying_npa_equals_1_homescreenHourly_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws  Exception {
									  logStep("Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario"); 
									  System.out.println("================= Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case  started =========================" ); 
									  Functions.validate_npa_homescrenhourly_dontsellmyinformation();
									  System.out. println("================= Verifying npa=1 in home screen hourly ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case  End =========================");
								      }*/
									  
									  @Test(priority = 790, enabled = true)	  
									  @Title("Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA  Travel Scenario") 
									  public void Verifying_npa_equals_1_homescreenmarquee_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws  Exception {
									  logStep("Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario"); 
									  System.out.println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================" ); 
										// Functions.validate_npa_homescreenmarquee_dontsellmyinformation();
									  System.out. println("================= Verifying npa=1 in home screen marquee  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case End =========================");
								      }
									  
										
										@Test(priority =792, enabled = true)  
										 @Title("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario") 
										 public void Verifying_npa_equals_1_Videos_adCall_USA_Privacy_DoNotSellMyInformation_for_USA_to_SERBIA_Travel_Scenario() throws Exception {
										 logStep("Verifying npa=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario" );  	  
										  System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case started =========================");
										// Functions.validate_npa_video_ad_dontsellmyinformation();
										 System.out. println("================= Verifying rdp=1 in videos  ad call for USA privacy when Advertising option set to Do Not Sell My Information for USA to SERBIA Travel Scenario test case End =========================");
										...
										@Title("Verify Criteo SDK inapp v2 call when privacy optout for USA to SERBIA Travel Scenario")
										public void Verify_Criteo_SDK_inapp_v2_Call_privacy_optout_for_USA_to_SERBIA_Travel_Scenario_tedt() throws Exception {
											System.out.println("==============================================");
											System.out.println(
									...
									//Functions.verifyCriteo_inapp_v2_Call("Criteo", false);
										...
										@Title("Verify Criteo SDK config app call when privacy optout for USA to SERBIA Travel Scenario")
	...
	//==========================================================================================================//
				...
				public void preConditionsTest_for_USA_SlectingStandardAdvertisingSettings() throws Exception {
     ...
     @Test(priority = 806, enabled = true)	  
	  @Title("Verifying Factual location.wfxtriggers.com api call supress  for USA privacy when Advertising option set to Standard Advertising Settings")
	  public void  Verifying_Factual_locationwfxtriggerscom_apiCall_supress_USA_Privacy_StandardAdvertisingSettings() throws Exception {
	   logStep("Verifying Factual location.wfxtriggers.com api call supress for USA privacy when Advertising option set to Standard Advertising Settings"); 
	   System.out.println("=================Verifying Factual location.wfxtriggers.com api call supress for USA privacy when Advertising option set to Standard Advertising Settings test case started =========================");
		  
		 // Functions.validating_Fatualcall_privacy_Optinmode_scenarion(); 
	   System.out. println("================= Verifying Factual location.wfxtriggers.com api call supress for USA privacy when Advertising option set to Standard Advertising Settings test case End =========================" );
	 
	  }
	  

	  @Test(priority = 808, enabled = true)	  
	  @Title("Verifying weatherfx api call presence for USA  privacy when Advertising option set to Standard Advertising Settings")
	  public void  Verifying_weatherfxapiCall_presence_USA_Privacy_StandardAdvertisingSettings() throws Exception {
	   logStep("Verifying weatherfx api call presence  for USA  privacy when Advertising option set to Standard Advertising Settings"); 
	   System.out.println("=================Verifying Factual location.wfxtriggers.com api call supress for USA  privacy when Advertising option set to Standard Advertising Settings test case started =========================");
		  ...
		  System.out.println("=================Verifying SOD custum param for  video ad call  USA privacy when Advertising option set to Standard Advertising Settings test case End =========================" );
		   ...
		   @Test(priority = 852, enabled = true)  
			...
			public void Verify_Criteo_SDK_config_app_Call_privacy_optin_for_USA() throws Exception {
				...
				//CharlesFunctions.archive_folder("Charles");
				 Thread.sleep(1000000000000000000000000000000000000000000);
				 Thread.sleep(1000000000000000000000000000000000000000000);
				 Thread.sleep(1000000000000000000000000000000000000000000);
				 Thread.sleep(1000000000000000000000000000000000000000000);
				 Thread.sleep(1000000000000000000000000000000000000000000);
